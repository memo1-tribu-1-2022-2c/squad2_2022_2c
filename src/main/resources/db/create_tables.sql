create table tbl_project (id bigint not null auto_increment, client_id integer not null, description varchar(2550), ending_date datetime(6), name varchar(255), project_type integer, starting_date datetime(6), state integer, version_id integer not null, primary key (id));
...
create table tbl_task (id bigint not null auto_increment, description varchar(2550), ending_date datetime(6), estimated_hours double precision, name varchar(255), previous_task_id bigint, priority integer, real_ending_date datetime(6), starting_date datetime(6), state integer, worked_hours double precision, project_id bigint, primary key (id));
